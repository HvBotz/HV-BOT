...
PICS = (environ.get('PICS', 'https://graph.org/file/51e893c4683d579993ec4.jpg')).split()
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HVCOMMUNITY')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/HVCOMMUNITY')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HVCOMMUNITY')
